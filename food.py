...
import tensorflow_hub as hub  # Pastikan tensorflow_hub diinstal jika menggunakan KerasLayer dari Hub
...
def load_model():
    # Menggunakan custom_objects untuk mendefinisikan KerasLayer
    model = tf.keras.models.load_model(
        r'C:\Users\ASUS\Documents\tugasakhir\streamlite\model_food.h5',
...
def predict_image(model, image):
    ...
    img_array = np.expand_dims(img_array, axis=0)  # Menambahkan batch size (1, 227, 227, 3)
...
def get_recipe(predicted_class, class_names):
    ...
    recipes_data = pd.read_csv(r'C:\Users\ASUS\Documents\tugasakhir\streamlite\data_resep.csv', delimiter=';')
...
def get_nutrition(predicted_class, class_names):
    ...
    nutrition_data = pd.read_csv(r'C:\Users\ASUS\Documents\tugasakhir\streamlite\total_nutrition_per_food.csv')
